...
struct qt_meta_stringdata_PillarItem_t {
    QByteArrayData data[2];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PillarItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PillarItem_t qt_meta_stringdata_PillarItem = {
    {
QT_MOC_LITERAL(0, 0, 10), // "PillarItem"
...
static const uint qt_meta_data_PillarItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject PillarItem::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_PillarItem.data,
    qt_meta_data_PillarItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PillarItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PillarItem.stringdata0))
